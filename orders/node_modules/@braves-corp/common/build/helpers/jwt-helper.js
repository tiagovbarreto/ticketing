...
var JWTHelper = /** @class */ (function () {
    ...
    JWTHelper.generateAuthToken = function (user) {
    ...
    JWTHelper.toHash = function (password) {
        return __awaiter(this, void 0, void 0, function () {
            var salt, buffer;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    JWTHelper.compare = function (storedPassword, suppliedPassword) {
        return __awaiter(this, void 0, void 0, function () {
